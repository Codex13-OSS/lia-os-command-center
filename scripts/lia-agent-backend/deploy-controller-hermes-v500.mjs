...
export const HERMES_V500_POLICY = Object.freeze({
...
export const HERMES_V500_PM2_ENV = Object.freeze({
...
export async function executeHermesV500Controller(argv) {
  return executeController({
    argv,
    policy: HERMES_V500_POLICY,
    pm2FunctionalEnv: HERMES_V500_PM2_ENV,
  });
}

async function main() {
  try {
    const result = await executeHermesV500Controller(process.argv.slice(2));
