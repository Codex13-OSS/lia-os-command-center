...
test('recovery preserves prepared runs with and without tickets across reopen and remains idempotent', async () => {
  ...
  try {
    ...
    const expected = { preservedRecoverable: 2, failedInterrupted: 0, terminalUnchanged: 0 };
